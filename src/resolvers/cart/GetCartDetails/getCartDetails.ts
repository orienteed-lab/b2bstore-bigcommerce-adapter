...
interface GetCartDetailsProps {
    variables: GetCartDetailsQueryVariables;
}

const GetCartDetails = (clientProps: ClientProps) => (resolverProps: GetCartDetailsProps) => {
    ...
    if (data) {
        // try {
        parsedData = getCartDetailsParser(data);
        // } catch (e) {
        //     console.error(e);
        // }
    }
