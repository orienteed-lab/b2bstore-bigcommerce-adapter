                ...
                item.options.length !== 0
                    ? items.push({
                          ...
                          product: {
                              ...
                              categories: [
                                  {
                                      name: '' // TODO_B2B: Get categories of the products
                                  }
                              ]
                          },
                ...
                items.push({
                    ...
                    prices: {
                        ...
                        price: {
                            ...
                            currency: '' // TODO_B2B: Get currency
                        },
                        row_total: {
                            __typename: 'Money',
                            value: item.list_price // TODO_B2B: Check if list price is row total; row total=((ordered item price * ordered item qty) + Tax) - Discount
        ...
        cart: {
            ...
            shipping_addresses: addresses.map((address) => ({
                ...
                selected_shipping_method: {
                    ...
                    carrier_title: 'Flat Rate', // TODO_B2B: Find and get carrier_title equivalent
                    method_title: address.shipping_method
                }
            })),
            selected_payment_method: {
                // TODO_B2B: Check how to get the selected payment method (if necessary)
                purchase_order_number: null, // TODO_B2B: Check what it is and get its BigCommerce equivalent
